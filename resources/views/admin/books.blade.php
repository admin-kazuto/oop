                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center position-relative">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                <a href="admin-add-book.html" class="btn btn-primary view-more">Add New Book</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="custom-table-effect table-responsive custom-table-search">
                                <table class=" mb-0 table table-bordered custom-datatable-border" id="datatable"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><img src="../assets/images/browse-books/01.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                            ...
                                            <td>$89</td>
                                            <td><a href="../shop/book-pdf.html"><i
                                                        class="ri ri-file-fill text-secondary font-size-18"></i></a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><img src="../assets/images/browse-books/02.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td><img src="../assets/images/browse-books/03.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td><img src="../assets/images/browse-books/04.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td><img src="../assets/images/browse-books/05.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td><img src="../assets/images/browse-books/06.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 align-items-center list-user-action">
                                                    <a class="bg-success-subtle px-1   rounded" data-toggle="tooltip"
                                                        data-placement="top" title="Edit" href="#">
                                                        <i class="ph ph-pencil-simple text-success custom-ph-icons"></i>
                                                    </a>
                                                    <a class="bg-danger-subtle delete-btn px-1 rounded" data-toggle="tooltip"
                                                        data-placement="top" title="Delete" href="#">
                                                        <i class="ph ph-trash text-danger custom-ph-icons"></i>
                                                    </a>
                                                </div>
                                        ...
                                        <tr>
                                            <td>7</td>
                                            <td><img src="../assets/images/browse-books/07.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>8</td>
                                            <td><img src="../assets/images/browse-books/08.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>9</td>
                                            <td><img src="../assets/images/browse-books/09.jpg" class="img-fluid rounded"
                                                    alt=""></td>
                                        ...
                                        <tr>
                                            <td>10</td>
                                            <td><img src="../assets/images/browse-books/10.jpg" class="img-fluid rounded"
                                                    alt=""></td>
