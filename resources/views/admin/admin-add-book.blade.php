    ...
    <main class="main-content">
        ...
        if (isset($_SESSION['success']) || isset($_SESSION['error'])) {
            $mes = isset($_SESSION['success'])
                ...
                : ['title' => 'Error', 'text' => 'Vui lớng nhập đầyy đủ thống tin', 'icon' => 'error'];
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center position-relative">
                            <div class="iq-header-title">
                                <h4 class="mb-0">Add New Books</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('add-book') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="author" class="select2-basic-single">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="select2-basic-single">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="price" type="text" class="form-control p-2 bg-white border">
                                </div>
                                <div class="form-group">
                                    <label>Quantity Book</label>
                                    <input name="quantity" type="text" class="form-control p-2 bg-white border">
                                </div>
                                <div class="form-group">
