        ...
        <a href="" class="navbar-brand">
            ...
            <div class="logo-main ">
                ...
                <img class="logo-color img-fluid "
                    src="resources/public/images/logo-white.png" height="30" alt="logo">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item iq-drop">
                    ...
                    <ul class="sub-nav collapse" id="Admin" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link <?= ($currentURL === '/author' || $currentURL === '/form-add-author') ? 'active' : '' ?>"
                                aria-current="page"
                                href="/author">
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link <?= ($currentURL === '/books' || $currentURL === '/form-add-book') ? 'active' : '' ?> "
                                aria-current="page"
                                href="/books">
