                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle p-1 bg-primary d-flex align-items-center justify-content-center"
                                            style="width:66px; height:66px; font-size: 22px;"><i class="ph ph-user text-white"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle p-1 bg-danger d-flex align-items-center justify-content-center"
                                            style="width:66px; height:66px; font-size: 22px;"><i class="ph ph-book text-white"></i>
                                        </div>
                                        <div class="text-left ms-3 mt-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle p-1 bg-warning d-flex align-items-center justify-content-center"
                                            style="width:66px; height:66px; font-size: 22px;"><i
                                                class="ph ph-shopping-cart text-white"></i>
                                        </div>
                                        <div class="text-left ms-3 mt-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle p-1 bg-info d-flex align-items-center justify-content-center"
                                            style="width:66px; height:66px; font-size: 22px;"><i
                                                class="ph ph-cell-tower text-white"></i></div>
                                        <div class="text-left ms-3 mt-3">
                                            ...
                                            <div class="details mb-2">
                                                ...
                                                <div class="progress bg-primary-subtle shadow-none w-100" style="height: 6px">
                                                    <div class="progress-bar bg-primary" data-toggle="progress-bar"
                                                        role="progressbar" aria-valuemin="0" aria-valuenow="90"></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header d-flex justify-content-between align-items-center mb-0">
                                    ...
                                    <div class="card-header-toolbar d-flex align-items-center">
                                        <div class="card-header-toolbar d-flex align-items-center">
                                            <div class="dropdown">
                                                <span id="post-dropdown-02" data-bs-toggle="dropdown" aria-expanded="false"
                                                    role="button" class="">
                                                    <i class="ri ri-more-fill"></i>
                                                </span>
                                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="post-dropdown-02">
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><i
                                                            class="ph ph-eye mr-2"></i> View</a>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><i
                                                            class="ph ph-trash mr-2"></i>
                                                        Delete</a>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><i
                                                            class="ph ph-pencil-simple mr-2"></i> Edit</a>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><i
                                                            class="ph ph-printer mr-2"></i> Print</a>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="#"><i
                                                            class="ph ph-file-arrow-down mr-2"></i>
                                                        Download</a>
                                                </div>
                                            </div>
                                        </div>
